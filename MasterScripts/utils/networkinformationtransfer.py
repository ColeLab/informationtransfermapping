...
networkdef = np.loadtxt('/projects2/ModalityControl2/data/GlasserKKPartition/Glasser_KK_Partitions.csv',delimiter=',')
...
def computeRestFC(subj):
    ...
    """
    filename = '/projects2/ModalityControl2/data/resultsMaster/glmRest_GlasserParcels/' + subj + '_rest_nuisanceResids_Glasser.csv'
...
def loadActivations(subj, net='all'):
    ...
    datafile = '/projects2/ModalityControl2/data/resultsMaster/glmMiniblockBetaSeries/' + subj + '_miniblock_taskBetas_Glasser.csv'
...
def networkToNetworkInformationTransferMapping(subj,fcmat,null=False):
    ...
    for ruledim in ruledims:
        ...
        rule_labels[ruledim] = np.loadtxt('/projects2/ModalityControl2/data/CPROTaskIdentifiers/' + subj + '_' + ruledim + '_miniblocksPerRule_MatlabIndices.csv',delimiter=',') - 1 
