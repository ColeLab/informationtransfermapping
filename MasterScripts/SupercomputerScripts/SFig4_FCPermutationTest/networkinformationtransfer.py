...
def computeRestFC(subj):
    ...
    """
    filename = datadir + '/FC_Estimates/' + subj + '_rest_nuisanceResids_Glasser.csv'
...
def networkToNetworkInformationTransferMapping(subj,fcmat,null=False,seed=None):
    """
    ...
    for ruledim in ruledims:
        ...
        rule_labels[ruledim] = np.loadtxt(datadir + '/CPROTaskIdentifiers/' + subj + '_' + ruledim + '_miniblocksPerRule_MatlabIndices.csv',delimiter=',') - 1 
