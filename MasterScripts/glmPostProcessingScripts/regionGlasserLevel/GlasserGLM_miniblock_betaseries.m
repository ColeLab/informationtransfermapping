function output = GlasserGLM_miniblock_betaseries(subj, gsr, nproc)
...
%   subj = subject number as a string
    ...
    if gsr==0
        outname1 = ['/projects2/ModalityControl2/data/resultsGlasser/glmMiniblockBetaSeries/' subj '_miniblock_nuisanceResids_Glasser.csv'];
        
    elseif gsr==1
        outname1 = ['/projects2/ModalityControl2/data/resultsGlasser/glmMiniblockBetaSeries/' subj '_miniblock_nuisanceResids_Glasser_noGSR.csv'];
    end
    outname2 = ['/projects2/ModalityControl2/data/resultsGlasser/glmMiniblockBetaSeries/' subj '_miniblock_taskBetas_Glasser.csv'];
